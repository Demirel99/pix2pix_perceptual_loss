...
class Pix2PixModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            # --- ADDED: Argument for Perceptual Loss weight ---
    ...
    def __init__(self, opt):
        ...
        # --- MODIFIED: Added G_perceptual loss name ---
        ...
        if self.isTrain:
            ...
            # --- ADDED: Initialize Perceptual Loss ---
            self.criterionPerceptual = networks.VGGPerceptualLoss(self.device)
